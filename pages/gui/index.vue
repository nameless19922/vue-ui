      ...
      <div class="layout__container">
        ...
        <div class="gui__item">
          ...
          <div class="gui__item-content">
            <div class="gui__item-row _width-auto">
              ...
              <div class="gui__item-cell">
                <Button :loading="loading" @click="loading = true;">After 10 secs loading is off</Button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="gui__item">
          ...
          <div class="gui__item-content">
            <div class="gui__item-row">
              <div class="gui__item-cell">
                <Select name="example" label="Simple select" :options="['First', 'Second', 'Third']" />
              </div>
            </div>
          </div>
        </div>
...
<script>
  import importDir from '@/utils/import-dir';
  import { dynamicMessage } from '@/utils/components';
  import { normalizeComponentPath, getComponentsList } from '@/utils/helpers';
